...
import { createEvent, fetchRooms } from "../api";
...
export function AddEventForm({ open, onClose, onEventAdded }) {
  ...
  const validateDateTime = (startDateTime, endDateTime) => {
    ...
    if (meetingDay < today) {
      return "Ne možete kreirati meeting u prošlosti.";
    }
  ...
  return (
    <FormModal
      ...
      title="Dodaj novi meeting"
      onSubmit={handleSubmit}
      submitLabel="Dodaj meeting"
            ...
            <DatePicker
              ...
              slotProps={{
                textField: {
                  ...
                  fullWidth: true,
                  error:
                    validationError.includes("Početak") ||
                    validationError.includes("prošlosti"),
